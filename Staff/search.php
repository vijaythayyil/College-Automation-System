...
<div class="subsec">
    <div class="bar">
        ...
        <input type="text" name="search_id"  placeholder="Enter Student ID" class="form-control m-2" style="width:25%; float:right;"/>
        <input type="submit" value="submit" class="btn btn-success m-2 pull-right">
        </form>
    </div>
    ...
    <table class="table table-hover" style="float: left;">
        ...
        <?php
          ...
          $sql = "SELECT * FROM department d inner join student s on s.department_Id=d.department_Id inner join mark m on m.student_Id=s.student_Id  where s.department_Id='$d_id' and m.student_Id='$search_id' group by m.semester,m.student_id order by year_of_admission desc";
